...
<div className="relative w-full h-full bg-background">
      ...
      <footer className="relative z-10 text-gray-700 container mx-auto px-8 md:px-12 py-6 md:py-10 md:pt-20">
        {/* Top Section */}
        <div className="flex flex-col lg:flex-row gap-25">
          {/* Brand */}
          <div className="lg:w-2/5">
            <h2 className="text-2xl font-bold text-gray-900">SOLE-CRAFTS</h2>
      ...
      <div className="mt-16 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {/* Customer Care */}
        <div>
          <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider">Customer Care</h3>
          <ul className="mt-4 space-y-3 text-sm text-gray-700">
        ...
        {/* My Account */}
        <div>
          <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider">My Account</h3>
          <ul className="mt-4 space-y-3 text-sm text-gray-700">
        ...
        {/* Promotions */}
        <div>
          <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider">Promotions</h3>
          <ul className="mt-4 space-y-3 text-sm text-gray-700">
